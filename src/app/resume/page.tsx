  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-16">
      ...
      <p className="text-muted-foreground mb-8">
        이력서 PDF를 다운로드하실 수 있습니다.
      </p>

      <div className="rounded-lg border border-border bg-card p-8 text-center">
        <div className="text-6xl mb-4 opacity-20">PDF</div>
        ...
        <div className="grid md:grid-cols-2 gap-6 text-sm">
          <div>
            ...
            <ul className="mt-2 space-y-1 text-muted-foreground">
              <li>LG전자, 삼성전자, 현대백화점 등 13개 프로젝트 수행</li>
              <li>DA 팀 0 to 3명 빌딩, 31개 스프린트 퍼실리테이션</li>
              <li>End-to-End 분석 파이프라인 설계 및 9개 클라이언트 지원</li>
            </ul>
          </div>
          <div>
            ...
            <ul className="mt-2 space-y-1 text-muted-foreground">
              <li>LG AI Research, 현대 NGV 등 AI 경진대회 5회+ 제작</li>
              <li>AARRR 퍼널 분석 &rarr; Active User +170%, 전환율 +77%</li>
            </ul>
          </div>
        </div>
      </div>
